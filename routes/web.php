...
Route::get('/paymob/callback', [\App\Http\Controllers\Payment\PaymobController::class, 'callback']);
...
// 1 - adding paymob credentials in admin dashboard
// 2 - adding paymob methods to frontend
// 3 - handle callback

// online card, bank installment, valu, mobile wallets
