                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                    <!-- Paymob card payment -->
                                    @if (get_setting('paymob_card_payment') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="paymob_card_payment" class="online_payment" type="radio"
                                                       name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img src="https://paymob.com/images/paymobLogo.png"
                                                         class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Visa/Mastercard') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    @endif
                                    <!-- Paymob Valu payment -->
                                    @if (get_setting('paymob_valu_payment') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="paymob_valu_payment" class="online_payment" type="radio"
                                                       name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img src="https://paymob.com/images/paymobLogo.png"
                                                         class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Valu') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    @endif
                                    <!-- Paymob Bank installment -->
                                    @if (get_setting('paymob_bank_installment_payment') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="paymob_bank_installment_payment" class="online_payment" type="radio"
                                                       name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img src="https://paymob.com/images/paymobLogo.png"
                                                         class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Bank installment') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    @if (get_setting('paymob_mobile_wallet_payment') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="paymob_mobile_wallet_payment" class="online_payment" type="radio"
                                                       name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img src="https://paymob.com/images/paymobLogo.png"
                                                         class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Mobile wallet') }}</span>
                                                        <input type="number" class="form-control phone_number" name="phone_number" placeholder="Mobile number">
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
