                  ...
                  <!-- Top content -->
                    ...
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="purchase_code" value="NullJungle" name="purchase_code" placeholder="**** **** **** ****" required="">
                        </div>
