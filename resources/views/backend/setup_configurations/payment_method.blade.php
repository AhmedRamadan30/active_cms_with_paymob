                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea rows="4" class="form-control" name="PAYMOB_API_KEY"
                                          placeholder="{{translate('Paymob Api key')}}" required>{{  env('PAYMOB_API_KEY') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_CARD_INTEGRATION_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Card integration ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_INTEGRATION_ID"
                                       value="{{  env('PAYMOB_CARD_INTEGRATION_ID') }}"
                                       placeholder="{{translate('Paymob Card integration ID')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_CARD_IFRAME_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Card iframe ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_IFRAME_ID"
                                       value="{{  env('PAYMOB_CARD_IFRAME_ID') }}"
                                       placeholder="{{translate('Paymob Card iframe ID')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_CARD_VALU_INTEGRATION_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Valu integration ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_VALU_INTEGRATION_ID"
                                       value="{{  env('PAYMOB_CARD_VALU_INTEGRATION_ID') }}"
                                       placeholder="{{translate('Paymob Valu integration ID')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_CARD_VALU_IFRAME_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Valu iframe ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CARD_VALU_IFRAME_ID"
                                       value="{{  env('PAYMOB_CARD_VALU_IFRAME_ID') }}"
                                       placeholder="{{translate('Paymob Valu iframe ID')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_BANK_INSTALLMENT_INTEGRATION_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Bank installment integration ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_BANK_INSTALLMENT_INTEGRATION_ID"
                                       value="{{  env('PAYMOB_BANK_INSTALLMENT_INTEGRATION_ID') }}"
                                       placeholder="{{translate('Paymob Bank installment integration ID')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_BANK_INSTALLMENT_IFRAME_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Bank installment iframe ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_BANK_INSTALLMENT_IFRAME_ID"
                                       value="{{  env('PAYMOB_BANK_INSTALLMENT_IFRAME_ID') }}"
                                       placeholder="{{translate('Paymob Bank installment iframe ID')}}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_MOBILE_WALLET_INTEGRATION_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Paymob Mobile wallet integration ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_MOBILE_WALLET_INTEGRATION_ID"
                                       value="{{  env('PAYMOB_MOBILE_WALLET_INTEGRATION_ID') }}"
                                       placeholder="{{translate('Paymob Mobile wallet integration ID')}}" required>
                            </div>
                        </div>
