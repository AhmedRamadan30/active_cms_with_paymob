    ...
    public function checkout(Request $request)
    {
        ...
        if ($request->payment_option != null) {
            ...
            if ($request->session()->get('combined_order_id') != null) {
                ...
                } else if ($request->payment_option == 'paymob_card_payment')
                {
                ...
                else if ($request->payment_option == 'paymob_valu_payment')
                {
                    return (new PaymobController)->checkingOut(
                        'paymob_valu_payment',
                        env('PAYMOB_CARD_VALU_INTEGRATION_ID'),
                        $request->session()->get('combined_order_id'),
                        env('PAYMOB_CARD_VALU_IFRAME_ID'));
                }
                else if ($request->payment_option == 'paymob_bank_installment_payment')
                {
                    return (new PaymobController)->checkingOut(
                        'paymob_bank_installment_payment',
                        env('PAYMOB_BANK_INSTALLMENT_INTEGRATION_ID'),
                        $request->session()->get('combined_order_id'),
                        env('PAYMOB_BANK_INSTALLMENT_IFRAME_ID'));
                }
                else if ($request->payment_option == 'paymob_mobile_wallet_payment')
                {
                    return (new PaymobController)->checkingOut(
